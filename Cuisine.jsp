<%-- 
    Document   : Cuisine
    Created on : Apr 14, 2015, 1:10:35 AM
...
<html>
    <head>
        ...
        <style>
            .myTable img:hover{height: 200px;width: 200px;}
            .myTable{
                margin-left: 400px;
            }
...
<%  
    ...
    ps=con.prepareStatement("Select * from ITEMS where rownum<=9");
    ...
    ArrayList i=new ArrayList();
        ...
        <tr>    
            <td>
                <img src="images/<%=i1.getItemimage() %>" alt="Food Image" height="150" width="160" />
                <br>
                <%=i1.getItemname() %>
                <br>
                <%=i1.getItemprice() %>
            ...
            <td>
                <img src="images/<%=i2.getItemimage() %>" alt="Food Image" height="150" width="160" />
                <br>
                <%=i2.getItemname() %>
                <br>
                <%=i2.getItemprice() %>
                <br>
                <a href="Features.jsp?code=<%=i2.getItemid() %>">Details</a>
            </td>
            <td>
                <img src="images/<%=i3.getItemimage() %>" alt="Food Image" height="150" width="160" />
                <br>
                <%=i3.getItemname() %>
                <br>
                <%=i3.getItemprice() %>
                <br>
                <a href="Features.jsp?code=<%=i3.getItemid() %>">Details</a>
            </td>
        </tr>
