<%-- 
    Document   : Login
    Created on : Mar 30, 2015, 2:19:52 AM
...
<html>
    ...
    <body>
        ...
        <form method="post" action="Loggedin.jsp">
            ...
            <div class="form-group"><label class="l1">Email<input type="text" name="T1" class="form-control" id="nameField" placeholder="abc@domain.com" /></label></div>
            <div class="form-group"><label class="l1">Password<input type="password" name="T2" class="form-control" id="nameField" placeholder="********" /></label></div>
