<%-- 
    Document   : Updated
    Created on : Apr 25, 2015, 6:52:58 PM
...
<html>
    ...
    <body>
        ...
        try{
                ...
                // out.println(itemid+"-"+itemimage+"-"+itemprice+"-"+itemname+"-"+itemtype+"-"+ingredients);
                 
                 
                 //out.print(itemid);
                 PreparedStatement ps=con.prepareStatement("Update items set itemimage=?,itemprice=?,itemname=?,itemtype=?,itemingredient=? where itemid='"+itemid+"'");
        ...
        {
            out.println("Error in page:"+e.getMessage());
        }  
        %>
