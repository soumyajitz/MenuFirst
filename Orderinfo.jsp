<%-- 
    Document   : Orderinfo
    Created on : Apr 27, 2015, 9:28:09 PM
...
<html>
  ...
  <%
    ...
    ps=con.prepareStatement("Select o.orderid,o.itemname,o.price,p.email from orders o,payments p where p.orderid=o.orderid");
    ResultSet rs=ps.executeQuery();
    out.println("<h1>Orders</h1>");
    out.println("<table class='table table-striped'>");
    out.println("<tr><th>ORDER NO.</th><th>ORDER ID</th><th>ITEM NAME</th><th>ITEM PRICE</th><th>USER EMAIL</th></tr>");
    int count=1;
    while(rs.next()){
        
        out.print("<tr><td>"+count+"</td><td>"+rs.getString(1)+"</td><td>"+rs.getString(2)+"</td><td>"+rs.getString(3)+"</td><td>"+rs.getString(4)+"</td></tr>");
count++;
